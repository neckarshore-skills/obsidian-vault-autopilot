...
| 4 | zero-width-strip | `[​‌‍﻿]` | (empty) | those 4 | Zero-width chars + BOM |
...
- Live plugin config `data.json` (`customRegexes`) - byte-exact verification of rules #2 (citation) and #4 (invisible chars), read under a user-gated production-vault access on 2026-06-16.
